...
namespace Http {
 ...
 void RestCacheClient::populateCacheObject(const std::string&, const std::string&) {}


 std::string RestCacheClient::getCachedObject(const std::string&) {
	 return "";
 }

 void RestCacheClient::onSuccess(Http::MessagePtr&&) {}

 void RestCacheClient::onFailure(Http::AsyncClient::FailureReason) {}
